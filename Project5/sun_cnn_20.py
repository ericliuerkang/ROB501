...
class CNN(torch.nn.Module):
    def __init__(self, num_bins): 
        ...
        self.conv1 = torch.nn.Conv2d(3, 16, stride=2, kernel_size=(3,3))
        self.norm1 = torch.nn.BatchNorm2d(16) 

        self.conv2 = torch.nn.Conv2d(16, 32, stride=2, kernel_size=(3,6))
        self.norm2 = torch.nn.BatchNorm2d(32) 

        self.conv3 = torch.nn.Conv2d(32, 64, stride=1, kernel_size=(3,3))
        self.norm3 = torch.nn.BatchNorm2d(64) 

        self.conv4 = torch.nn.Conv2d(64, 128, stride=1, kernel_size=(3,3))
        self.norm4 = torch.nn.BatchNorm2d(128)   

        self.pool4 = torch.nn.MaxPool2d((3,3),stride=3)

        self.conv5 = torch.nn.Conv2d(128, 320, stride=1, kernel_size=(3,3)) # 3 input channels, 16 output channels
        self.norm5 = torch.nn.BatchNorm2d(320)   

        self.relu = torch.nn.ReLU()
        self.conv6 = torch.nn.Conv2d(320,num_bins, kernel_size=(2,14))
...
if __name__ == "__main__": 
    ...
    dset_loaders = {x: torch.utils.data.DataLoader(dsets[x], batch_size=24, shuffle=True, num_workers=4) for x in ['train', 'val']}
